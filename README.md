...
![Alt text](PublicNetwork/ipsummary2-2.png?raw=true)
![Alt text](PublicNetwork/ipsummary3-2.png?raw=true)

## Examine your computer's full routing table
![Alt text](PublicNetwork/routingtable1-2.png?raw=true)
![Alt text](PublicNetwork/routingtable2-2.png?raw=true)
![Alt text](PublicNetwork/routingtable3-2.png?raw=true)

## Use arp to discover hosts that are on the same network

![Alt text](PublicNetwork/arp1-2.png?raw=true)
...
### The default router
![Alt text](PublicNetwork/ping2-2.png?raw=true)
### One of your domain name servers
![Alt text](PublicNetwork/ping3-2.png?raw=true)
### www.lmu.edu
![Alt text](PublicNetwork/ping4.png?raw=true)
### A host on the Internet (most likely a website, but for more variety, see if you can find a different kind of public host, such as a game server, mail server, chat server, or cloud storage)
![Alt text](PublicNetwork/ping5.png?raw=true)
...
### The default router
![Alt text](PublicNetwork/traceroute2-2.png?raw=true)
### One of your domain name servers
![Alt text](PublicNetwork/traceroute2-2.png?raw=true)
### www.lmu.edu
![Alt text](PublicNetwork/traceroute3-2.png?raw=true)
### A host on the Internet (most likely a website, but for more variety, see if you can find a different kind of public host, such as a game server, mail server, chat server, or cloud storage)
